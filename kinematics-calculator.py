...
def calcular_mru():
    ...
    if opcao == '1':
        v = ler_float("Velocidade (m/s): ")
        t = ler_float("Tempo (s): ")
        d = v * t
        print(f"\nDistância calculada: {d:.2f} metros")
    elif opcao == '2':
        d = ler_float("Distância (m): ")
        t = ler_float("Tempo (s): ")
        if t == 0:
...
def calcular_muv():
    ...
    if opcao == '1':
        v0 = ler_float("Velocidade Inicial (v0 em m/s): ")
        a = ler_float("Aceleração (a em m/s²): ")
        t = ler_float("Tempo (t em s): ")
        v = v0 + (a * t)
        ...
        v0 = ler_float("Velocidade Inicial (v0 em m/s): ")
        a = ler_float("Aceleração (a em m/s²): ")
        d = ler_float("Distância percorrida (Δs em metros): ")
        ...
        v = ler_float("Velocidade Final (v em m/s): ")
        v0 = ler_float("Velocidade Inicial (v0 em m/s): ")
        t = ler_float("Tempo (t em s): ")
        if t == 0:
            print("\nErro: O tempo não pode ser zero!")
